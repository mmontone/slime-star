...
- [[https://github.com/mmontone/lisp-system-browser][Lisp System
  Browser]]
...
- Use [[#dedicated-emacs-buffers-for-output-streams][dedicated Emacs
  buffers]] for output streams.
- Interactive [[#interactive-trace-and-print-buffers][trace and print
  buffers]].
...
For debugging, insert a call to =swank-print-buffer:prn= in what you
